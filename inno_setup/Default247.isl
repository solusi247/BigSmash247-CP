...
SelectDirBrowseLabel=To continue, click Next. If you would like to select a different folder, click Browse.%n - Please change the DRIVE only to keep the path short.%n - Please avoid SPACE character.
